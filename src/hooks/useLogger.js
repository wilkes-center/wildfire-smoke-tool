...
export const useLogger = (componentName, options = {}) => {
  ...
  const logAsyncOperation = useCallback(
    async (operation, asyncFn, data = {}) => {
  ...
  const logStateChange = useCallback(
    (stateName, oldValue, newValue, data = {}) => {
