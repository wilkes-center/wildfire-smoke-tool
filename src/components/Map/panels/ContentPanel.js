...
const ContentPanel = ({ isDarkMode, children, title, subtitle }) => {
  return (
    <div className="w-80">
      <div className={`backdrop-blur-sm rounded-lg shadow-lg px-4 py-3 border-2 ${
        isDarkMode ? 'border-white bg-gray-900/95 text-white' : 'border-mahogany bg-white/95 text-gray-800'
      }`}>
